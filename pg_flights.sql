...
CREATE FUNCTION public.get_tickets_by_customer(_customer_id bigint) RETURNS TABLE(id bigint, customer_id bigint)
    LANGUAGE plpgsql
    AS $$
        BEGIN
           RETURN QUERY
...
21	1	1	2	2021-08-28 09:10:59.897666	2021-08-29 09:10:59.897666	100
22	1	1	3	2021-08-28 09:10:59.897666	2021-08-29 09:10:59.897666	100
23	1	1	4	2021-08-26 09:10:59.897666	2021-08-26 09:10:59.897666	100
...
SELECT pg_catalog.setval('public.flights_id_seq', 28, true);
